...
export class ChampionsService {
  champions: Champion[] = [
    ...
    {name: "Ambessa", gender: "Féminin", role: ["Jungle", "Top"], species: ["Humain"], resource: "Énergie", range: ["Mêlée"], region: ["Noxus", "Piltover"], year: 2024},
    ...
    {name: "Aurora", gender: "Féminin", role: ["Mid", "Top"], species: ["Vastaya"], resource: "Mana", range: ["À distance"], region: ["Freljord"], year: 2024},
    ...
    {name: "Cho'Gath", gender: "Masculin", role: ["Top"], species: ["Être du néant"], resource: "Mana", range: ["Mêlée"], region: ["Le Néant"], year: 2009},
    {name: "Corki", gender: "Masculin", role: ["ADC", "Mid"], species: ["Yordle"], resource: "Mana", range: ["À distance"], region: ["Bandle", "Piltover"], year: 2009},
    {name: "Darius", gender: "Masculin", role: ["Top"], species: ["Humain"], resource: "Mana", range: ["Mêlée"], region: ["Noxus"], year: 2012},
    ...
    {name: "Elise", gender: "Féminin", role: ["Jungle"], species: ["Humain", "Altéré Magiquement"], resource: "Mana", range: ["Mêlée", "À distance"], region: ["Noxus", "Îles Obscures"], year: 2012},
    ...
    {name: "Fiddlesticks", gender: "Autre", role: ["Jungle"], species: ["Démon", "Esprit"], resource: "Mana", range: ["À distance"], region: ["Runeterra"], year: 2009},
    ...
    {name: "Jayce", gender: "Masculin", role: ["Mid", "Top"], species: ["Humain"], resource: "Mana", range: ["Mêlée", "À distance"], region: ["Piltover"], year: 2012},
    ...
    {name: "Kennen", gender: "Masculin", role: ["Top"], species: ["Yordle"], resource: "Énergie", range: ["À distance"], region: ["Ionia"], year: 2010},
    ...
    {name: "Maokai", gender: "Masculin", role: ["Support", "Top"], species: ["Esprit"], resource: "Mana", range: ["Mêlée"], region: ["Îles Obscures"], year: 2011},
    ...
    {name: "Naafiri", gender: "Féminin", role: ["Jungle"], species: ["Darkin", "Chien"], resource: "Mana", range: ["Mêlée"], region: ["Shurima"], year: 2023},
    ...
    {name: "Pantheon", gender: "Masculin", role: ["Support", "Top"], species: ["Hôte", "Humain"], resource: "Mana", range: ["Mêlée"], region: ["Targon"], year: 2010},
    {name: "Poppy", gender: "Féminin", role: ["Support", "Top"], species: ["Yordle"], resource: "Mana", range: ["Mêlée"], region: ["Demacia"], year: 2010},
    ...
    {name: "Quinn", gender: "Féminin", role: ["Top"], species: ["Humain"], resource: "Mana", range: ["À distance"], region: ["Demacia"], year: 2013},
    ...
    {name: "Shaco", gender: "Masculin", role: ["Jungle"], species: ["Esprit"], resource: "Mana", range: ["Mêlée"], region: ["Runeterra"], year: 2009},
    ...
    {name: "Smolder", gender: "Masculin", role: ["ADC", "Mid"], species: ["Dragon"], resource: "Mana", range: ["À distance"], region: ["Camavor", "Noxus"], year: 2024},
    ...
    {name: "Taliyah", gender: "Féminin", role: ["Jungle", "Mid"], species: ["Humain", "Né magique"], resource: "Mana", range: ["À distance"], region: ["Shurima"], year: 2016},
    ...
    {name: "Teemo", gender: "Masculin", role: ["Jungle", "Top"], species: ["Yordle"], resource: "Mana", range: ["À distance"], region: ["Bandle"], year: 2009},
    ...
    {name: "Wukong", gender: "Masculin", role: ["Jungle", "Top"], species: ["Vastaya"], resource: "Mana", range: ["Mêlée"], region: ["Ionia"], year: 2011},
    ...
    {name: "Yorick", gender: "Masculin", role: ["Top"], species: ["Humain", "Altéré Magiquement"], resource: "Mana", range: ["Mêlée"], region: ["Îles Obscures"], year: 2011},
    ...
    {name: "Zed", gender: "Masculin", role: ["Mid"], species: ["Humain", "Altéré Magiquement"], resource: "Énergie", range: ["Mêlée"], region: ["Ionia"], year: 2012},
    ...
    {name: "Zoé", gender: "Féminin", role: ["Mid", "Support"], species: ["Hôte", "Humain"], resource: "Mana", range: ["À distance"], region: ["Targon"], year: 2017},
    {name: "Zyra", gender: "Féminin", role: ["Support"], species: ["Inconnu"], resource: "Mana", range: ["À distance"], region: ["Ixtal"], year: 2012}
  ];
