...
import { IonContent, ViewWillEnter, IonButton, IonItem, IonLabel, IonList, IonCard, IonCardContent, IonSelect, IonSelectOption, IonBadge } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, CommonModule, FormsModule, IonButton, IonItem, IonLabel, IonList, IonCard, IonCardContent, IonSelect, IonSelectOption, IonBadge, NavbarComponent]
})
